...
final class AnalyticsService {
    ...
    enum Event: String {
        ...
        case purchaseVerifyFailed    = "purchase_verification_failed"
        case restorePurchases        = "restore_purchases_initiated"
        case restoreCompleted        = "restore_purchases_completed"
        case restoreFailed           = "restore_purchases_failed"
        case dataExported            = "data_exported"
        case autoExportCompleted     = "auto_export_completed"
